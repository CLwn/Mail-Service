...
public class Main {
    public static void main(String[] args) throws java.lang.Exception {
        ...
        System.out.println("---------------------------CHANGE IMPLEMENTATION OF MAIL SYSTEM TO REDIS--------------------------");
        ...
        System.out.println("---------------------------GROUP MESSSAGES BY SUBJECT--------------------------");
        Map<String, List<Message>> map2 = mailSystem.groupMessagePerSubject();
        map2.forEach((s, messages) -> System.out.println(messages.toString()));
        ...
        System.out.println("---------------------------GROUP MESSSAGES BY SUBJECT--------------------------");
        Map<String, List<Message>> map3 = mailSystem.groupMessagePerSubject();
        map3.forEach((s, messages) -> System.out.println(messages.toString()));
